...
set "MAX_LOAD_MORE=10"
set "RESULT_PAGE_LIMIT=1"
set "DISABLED_RESULT_MODE=skip"
set "CONCURRENCY=1"

echo ============================================
echo WSOP LIVE Player Standings Crawler (UI Mode)
echo ============================================
echo.
echo Target:
...
echo A Playwright Inspector GUI window will open.
echo You can step through code and inspect DOM elements.
echo.
