    ...
    def fetch_issues(self) -> list[Issue]:
        ...
        return [
            ...
            Issue(
                ...
                assignees=["dev-han"],
                milestone="May Release",
                url=f"https://github.com/{self.owner}/{self.repo}/issues/36",
            ...
            Issue(
                ...
                assignees=["qa-seo"],
                milestone="Test Hardening",
                url=f"https://github.com/{self.owner}/{self.repo}/issues/37",
            ...
            Issue(
                ...
                assignees=["pm-choi"],
                milestone="Backlog",
                url=f"https://github.com/{self.owner}/{self.repo}/issues/38",
