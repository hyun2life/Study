...
```powershell
powershell -ExecutionPolicy Bypass -File automation\run_player_standings_check.ps1 -PlayersUrl "https://www.wsop.com/player-standings/" -Headed -Limit 10 -ResultLimit 3 -Out "automation\output\wsop-player-standings-live-report.json"
```
