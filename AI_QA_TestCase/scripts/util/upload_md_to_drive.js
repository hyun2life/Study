...
const ROOT_FOLDER_ID = process.env.SPEC_DRIVE_FOLDER_ID || process.env.TC_DRIVE_FOLDER_ID || '';
...
async function uploadFiles(folderName, filePaths) {
    if (isPlaceholder(ROOT_FOLDER_ID)) {
        throw new Error('SPEC_DRIVE_FOLDER_ID 또는 TC_DRIVE_FOLDER_ID 환경변수가 필요합니다.');
    }
