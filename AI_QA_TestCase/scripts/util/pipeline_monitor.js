...
const PROJECT_ROOT = process.env.WORK_ROOT || path.resolve(__dirname, '..', '..');
const STATE_FILE = path.join(PROJECT_ROOT, 'team', 'state.json');
const HISTORY_FILE = path.join(PROJECT_ROOT, 'team', 'history.json');
const TIMING_FILE = path.join(PROJECT_ROOT, 'team', 'timing.csv');
const STATUS_DIR = path.join(PROJECT_ROOT, 'team', 'status');
